...
const stripe =  new Stripe("sk_test_51PPQVXP01Wr75qZsuiG9XvZpCfPxcW5W3MoOH8S19XvfrNLFVoBY5P7zYlQCuoBy2miutulc5axAcQHVtV3QT9tO00fOQfQ2sV");
...
router.get("/", async (req, res) => {
  ...
  router.post("/:hotelId/booking/payment-intent", verifyToken, async (req, res) => {
  ...
  router.post("/:hotelId/booking", verifyToken, async (req, res) => {
    try {
      ...
      const hotel = await Hotel.findOne({ where: { hotelId: req.params.hotelId } });
